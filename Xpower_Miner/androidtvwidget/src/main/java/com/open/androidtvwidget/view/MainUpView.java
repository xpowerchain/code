...
public class MainUpView extends FrameLayout {
    ...
    public static final float DEFUALT_SCALE = 1.0f;
    public static final float DEFAULT_LARGE_SCALE = 1.2f;

    private int mMaxEnlargeX;//x方向最大的缩放值 
    private int mMaxEnlargeY;//y方向最大的缩放值
    ...
    public void setMaxEnlargeX(int maxXInPx) {
        mMaxEnlargeX = maxXInPx;
    }

    public void setMaxEnlargeY(int maxYInPx) {
        mMaxEnlargeY = maxYInPx;
    }
    ...
    public void setFocusView(View view) {
        setFocusView(view, DEFAULT_LARGE_SCALE, DEFAULT_LARGE_SCALE);
    }
    ...
    public void setFocusView(View view, float scaleX, float scaleY) {
        ...
        if (this.mEffectBridge != null) {
            // 如果x方向的增加值超过了设定的值，则重新计算比例 
            if (mMaxEnlargeX > 0 && mMaxEnlargeX < (scaleX - 1) * view.getMeasuredWidth()) {
                scaleX = (float) mMaxEnlargeX / view.getMeasuredWidth() + 1;
            }

            if (mMaxEnlargeY > 0 && mMaxEnlargeY < (scaleY - 1) * view.getMeasuredWidth()) {
                scaleY = (float) mMaxEnlargeY / view.getMeasuredWidth() + 1;
            }
